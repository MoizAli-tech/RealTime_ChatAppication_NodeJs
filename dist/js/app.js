...
var userEmail = (_document$getElements = document.getElementsByClassName("chatBox")[0].dataset) === null || _document$getElements === void 0 ? void 0 : _document$getElements.user;
var chatWrapper = document.getElementsByClassName("chatBox-wrapper")[0];
...
function msg(user, email, message) {
  var mainChatbox = document.getElementsByClassName("chatBox")[document.getElementsByClassName("chatBox").length - 1];
  ...
  textbox.innerHTML = " <p>From : ".concat(user, "</p>\n                            <p> To : ").concat(email, "</p>\n                            ").concat(message, "\n                        ");
...
send.addEventListener('click', function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/', {
    ...
    if (response.data.redirect == "/") {
      ...
      var _response$data = _objectSpread({}, response.data),
        sender = _response$data.sender,
        receiver = _response$data.receiver,
        _message = _response$data.message;
      msg(sender, receiver, _message);
...
var receiverBtn = document.getElementById("receiverBtn");
receiverBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/setReceiver", {
    email: email
  }, {
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded'
    ...
    var _response$data2 = response.data,
      receiver = _response$data2.receiver,
      message = _response$data2.message;
    if (message) {
      sweetalert__WEBPACK_IMPORTED_MODULE_0___default()("".concat(message));
    } else if (receiver) {
      sweetalert__WEBPACK_IMPORTED_MODULE_0___default()("Receiver has been set").then(function (value) {
        window.location = "/";
      });
    }
  })["catch"](function (error) {
...
socket.on("message", function (user, email, message) {
